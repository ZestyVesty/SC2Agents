# Acknowledgement
This original repo belongs to Ray Heberer at https://github.com/rayheberer/SC2Agents.

I used and modified his code for my project
...
### 2. Install tensorflow easy way

install anaconda
create a new conda environement
enter the conda environment

if want to run on GPU -> conda install tensorflow-gpu
if want to run on CPU -> conda install tensorflow
